...
CreateAction::CreateAction(EntityID t_id, ObjectType t_object_type,
    ...
    : IAction(ActionType::CREATE, t_id) {
...
sf::Vector2f CreateAction::getPosition() const { return m_position; }

std::string CreateAction::getSpritePath() const { return m_sprite_path; }
